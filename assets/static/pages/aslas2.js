    ...
    "7tlc": function(e, t, n) {
        (function(e) {
            ...
            function l(e, n, r) {
                ...
                if (e.showHidden && (u = Object.getOwnPropertyNames(n)),
                ...
                (y(n) && (x = !0,
                E = ["[", "]"]),
                T(n)) && (w = " [Function" + (n.name ? ": " + n.name : "") + "]");
                return v(n) && (w = " " + RegExp.prototype.toString.call(n)),
                O(n) && (w = " " + Date.prototype.toUTCString.call(n)),
                j(n) && (w = " " + a(n)),
                0 !== u.length || x && 0 != n.length ? r < 0 ? v(n) ? e.stylize(RegExp.prototype.toString.call(n), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(n),
                s = x ? function(e, t, n, r, o) {
                    for (var i = [], u = 0, c = t.length; u < c; ++u)
                        P(t, String(u)) ? i.push(p(e, t, n, r, String(u), !0)) : i.push("");
            ...
            function p(e, t, n, r, o, i) {
                ...
                if ((f = Object.getOwnPropertyDescriptor(t, o) || {
                    value: t[o]
                }).get ? c = f.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : f.set && (c = e.stylize("[Setter]", "special")),
                P(r, o) || (u = "[" + o + "]"),
                c || (e.seen.indexOf(f.value) < 0 ? (c = h(n) ? l(e, f.value, null) : l(e, f.value, n - 1)).indexOf("\n") > -1 && (c = i ? c.split("\n").map((function(e) {
                    return "  " + e
                }
                )).join("\n").substr(2) : "\n" + c.split("\n").map((function(e) {
                    return "   " + e
                ...
                b(u)) {
                    ...
                    u = e.stylize(u, "name")) : (u = u.replace(/'/g, "\\'").replace(/\\"/g, '"').replace(/(^"|"$)/g, "'"),
